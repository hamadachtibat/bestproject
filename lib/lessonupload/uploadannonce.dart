...
class uploadannonce extends StatefulWidget {
  @override
  _uploadannonceState createState() => _uploadannonceState();
}

class _uploadannonceState extends State<uploadannonce> {
  ...
  uploadpdf()async{
    if (filepdf!= null) {
      ...
      Crudmethods().Aadanonce(lessondata).then((result){
